class FooterComponent extends HTMLElement {
    ...
    this.shadowRoot.innerHTML += `
      <footer id="footer">
        <section class="footer_logo">
          <object type="image/svg+xml" data="assets/svg/logolargepage.svg"></object>
          <span>Tel 982-321-123</span>
        </section>
        <section class="footer_redes">
          <a href="" class="email">Correo: example@gmail.com</a>
          <div>
  ...
  async templateCSS() {
    await fetch('./components/footer/footerComponent.css')
